let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  poweredBy: `Drevet af ZeroKanPay`,
  ...
  becsDebitTerms: `Ved at angive dine bankkontooplysninger og bekræfte denne betaling accepterer du denne anmodning om direkte debitering og serviceaftalen om anmodning om direkte debitering og giver ZeroKanPay Payments [AU entity TBD] Direct Debit User ID-nummer [TBD] ( \"ZeroKanPay\") tilladelse til at debitere din konto via Bulk Electronic Clearing System (BECS) på vegne af ZeroKanPay Payment Widget (\"Forhandleren\") for eventuelle beløb, som Forhandleren har meddelt dig separat. Du bekræfter, at du enten er en kontoindehaver eller en autoriseret underskriver på den konto, der er angivet ovenfor.`,
  cardTerms: str =>
