let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  poweredBy: `Unterstützt von ZeroKanPay`,
  ...
  achBankDebitTerms: str =>
    `Indem Sie Ihre Kontonummer angeben und diese Zahlung bestätigen, autorisieren Sie diese ${str} und ZeroKanPay, unser Zahlungsdienstleister, um Anweisungen an Ihre Bank zu senden, um Ihr Konto zu belasten, und Ihre Bank, um Ihr Konto gemäß diesen Anweisungen zu belasten. Sie haben gemäß den Bedingungen Ihrer Vereinbarung mit Ihrer Bank Anspruch auf eine Rückerstattung von Ihrer Bank. Eine Rückerstattung muss innerhalb von 8 Wochen ab dem Datum der Belastung Ihres Kontos beantragt werden.`,
  sepaDebitTerms: str =>
  ...
  becsDebitTerms: `Indem Sie Ihre Bankkontodaten angeben und diese Zahlung bestätigen, stimmen Sie dieser Lastschriftanforderung und der Servicevereinbarung für Lastschriftanträge zu und ermächtigen ZeroKanPay Payments [AU entity TBD] Lastschriftbenutzer-ID-Nummer [TBD] („ZeroKanPay“), Ihr Konto zu belasten Konto über das Bulk Electronic Clearing System (BECS) im Namen von ZeroKanPay Payment Widget (der „Händler“) für alle Beträge, die Ihnen vom Händler gesondert mitgeteilt werden. Sie bestätigen, dass Sie entweder Kontoinhaber oder Zeichnungsberechtigter des oben aufgeführten Kontos sind.`,
  cardTerms: str =>
