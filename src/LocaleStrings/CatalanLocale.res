let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  poweredBy: `Amb tecnologia de ZeroKanPay`,
  ...
  documentTypeLabel: `Tipus de doc`,
  ...
  achBankDebitTerms: str =>
    `En facilitar el número de compte i confirmar el pagament, autoritza ${str} i ZeroKanPay, el nostre proveïdor de serveis de pagament, a enviar ordres al seu banc perquè apliqui els càrrecs corresponents al compte. Tindrà dret a rebre un reembossament del banc d'acord amb els termes i condicions del contracte que hi hagi subscrit. El reembossament s'ha de sol·licitar en un termini de 8 setmanes des de la data en què es va aplicar el càrrec al compte.`,
  sepaDebitTerms: str =>
  ...
  becsDebitTerms: `En facilitar les dades del compte bancari i confirmar el pagament, accepta aquesta sol·licitud de domiciliació bancària i l'acord de servei corresponent. A més, autoritza ZeroKanPay Payments [AU entity TBD], amb número d'identificació d'usuari de domiciliació bancària [TBD], («ZeroKanPay») a aplicar càrrecs al compte a través del sistema de compensació electrònica massiva (BECS) en nom de ZeroKanPay Payment Widget (el «comerç») per a qualsevol import que el comerç li comuniqui individualment. Certifica que és titular d'un compte o signatari autoritzat del compte que s'indica anteriorment.`,
  cardTerms: str =>
