let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  poweredBy: `מופעל על ידי ZeroKanPay`,
  validThruText: `תוקף`,
  ...
  achBankDebitTerms: str =>
    `על ידי הזנת מספר החשבון שלך ואישור תשלום זה, אתה מאשר את ${str} ואת ZeroKanPay, ספק השירותים התשלום שלנו, לשלוח הוראות לבנק שלך לחייב את החשבון שלך ולהפחית את החשבון שלך על פי ההוראות האלה. אתה זכאי לקבל החזר מהבנק שלך על פי תנאי ההסכם שלך עם הבנק. ההחזר יכול להידרש תוך 8 שבועות מהתאריך שבו הוא הופחת מחשבונך.`,
  sepaDebitTerms: str =>
  ...
  becsDebitTerms: `על ידי הזנת פרטי החשבון הבנקאי שלך ואישור תשלום זה, אתה מסכים לבקשת החיוב הישיר ולהסכם תשלום בקשת החיוב הישיר ומאשר את ZeroKanPay Payments [AU entity TBD] מספר זיהוי משתמש בקשת החיוב הישיר [TBD] (ZeroKanPay) לחייב את החשבון שלך דרך מערכת BECS (Bulk Electronic Clearing System) בשם ZeroKanPay Payment Widget (הסוחר) עבור סכומים הודעו לך בנפרד על ידי הסוחר. אתה מאשר שאתה בעל החשבון או חותם מורשה בחשבון שצוין למעלה.`,
  cardTerms: str =>
  ...
  giftCardPinLabel: `PIN של כרטיס מתנה`,
